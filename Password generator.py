...
class PasswordGenerator:
    ...
    def __init__(self, root):
        ...
        self.heading_label = tk.Label(root, text="Password Generator", font=("Arial", 18, "bold", "underline"),bg="lightyellow", fg="purple")

        self.heading_label.pack(pady=2)



        self.username_label = tk.Label(root, text="Enter User Name:",  font=("Arial", 14, "bold"), fg="green",bg="light yellow")
        ...
        self.generate_button = tk.Button(root, text="Generate Password", command=self.generate_password, bg="lightyellow", fg="red", font=("Arial", 14))

        self.generate_button.pack(pady=20)



        self.generated_password_label = tk.Label(root, text="Generated Password:", font=("Arial", 10),bg ="pink")

        self.generated_password_label.pack(pady=10)



        self.generated_password_frame = tk.Frame(root, bg="black", height=100, width=300)
        ...
        self.accept_button = tk.Button(root, text="Accept", command=self.accept_password, font=("Arial", 12),bg = "light green")

        self.accept_button.pack(side=tk.LEFT, padx=10, pady=5)



        self.reset_button = tk.Button(root, text="Reset", command=self.reset_password, font=("Arial", 12),bg = "orange")
